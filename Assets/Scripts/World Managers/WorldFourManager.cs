...
public class WorldFourManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (playedFact0 && !playedFact1 && timePassedSinceLastDialogue > 30)
        {
            playedFact1 = true;
        ...
        if (playedFact0 && playedFact1 && !playedWinDialogue && timePassedSinceLastDialogue>30)
        {
        ...
        if (playedWinDialogue && timePassedSinceLastDialogue > 30)
        {
